...
# def fetch_documents(user_id,category):
...
#         file_details = []
#         tree = []
#         query = "SELECT file_id, file_name, file_type, category, file_size FROM files WHERE uid = %s and category = %s"
...
# def fetch_documents_for_institute_view(file_id):
#     # Clear existing items in the treeview and reset the file_details list
...
#         file_details = []
#         tree = []
#         query = "SELECT file_id, file_name, file_type, category, file_size,uid FROM files WHERE file_id = %s"
...
def count_documents(user_id, category):
    try:
        ...
        query = "SELECT COUNT(*) FROM files WHERE uid = %s AND category = %s"
        cursor.execute(query, (user_id, category))
