...
def open_personal_docs(user_id,window):
    root = tk.Toplevel(window)
    root.title("Personal documents.")
    docs_count = count_documents(user_id,"Personal Documents")
    ...
    Example(user_id, "Personal Documents", root).pack(side="top", fill="both", expand=True, padx=10, pady=10)
...
if __name__ == "__main__":
    root =tk.Tk()
    open_personal_docs("S353356847444",root)
# import tkinter as tk
