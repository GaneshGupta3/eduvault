...
# #     open_marksheets("S819412384089", "Marksheets")
...
class Example(tk.LabelFrame):
    def __init__(self, user_id, category, *args, **kwargs):
        ...
        self.documents = document_list[:docs_count]  # Limiting to first n documents
...
def open_marksheets(user_id, window):
    root = tk.Toplevel(window)
    root.title("Marksheet page")
    docs_count = count_documents(user_id,"Marksheets")
    ...
    Example(user_id, "Marksheets", root).pack(side="top", fill="both", expand=True, padx=10, pady=10)
